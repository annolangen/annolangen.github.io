...
},{}],"node_modules/lit-html/directives/style-map.js":[function(require,module,exports) {
"use strict";
...
},{"../lit-html.js":"node_modules/lit-html/lit-html.js"}],"ts/app.ts":[function(require,module,exports) {
"use strict";
...
function newConverter() {
  ...
  return function () {
    return lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    <form class=\"pure-form\">\n      <input\n        id=\"celsius\"\n        .value=\"", "\"\n        @input=", "\n      />\n      <label for=\"celsius\">Celsius =</label>\n      <input id=\"fahrenheit\" .value=\"", "\" @input=", " />\n      <label for=\"fahrenheit\">Fahrenheit</label>\n    </form>\n  "], ["\n    <form class=\"pure-form\">\n      <input\n        id=\"celsius\"\n        .value=\"", "\"\n        @input=", "\n      />\n      <label for=\"celsius\">Celsius =</label>\n      <input id=\"fahrenheit\" .value=\"", "\" @input=", " />\n      <label for=\"fahrenheit\">Fahrenheit</label>\n    </form>\n  "])), Math.round((temp - 32) / 1.8), celsiusInput, temp, fahrenheitInput);
  };
}

function newBooker() {
  var flightType = 'one-way flight';
  var out = new Date().toISOString().substr(0, 10); // match yyyy-MM-dd format used by date input
...
function newCrud() {
  ...
  function selectionChange() {
    ...
    var match = nameList[selected].match('([^,]*), (.*)');
  ...
  var update = function update() {
    return nameList[selected || 0] = last.value + ', ' + first.value;
  };
...
function newCircles() {
  ...
  function selectHandler(index) {
    ...
    function selectCircle(e) {
      selected = index;
      undo.push(state); // New state with fresh copy of selected circle

      state = __spreadArrays(state);
      state[selected] = __assign({}, state[selected]);
  ...
  return function () {
    return lit_html_1.html(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    <div style=\"content-align:center\">\n      <span\n        class=\"pure-button pure-button-primary\"\n        ?disabled=", "\n        @click=", "\n        >Undo</span\n      >\n      <span\n        class=\"pure-button pure-button-primary\"\n        ?disabled=", "\n        @click=", "\n        >Redo</span\n      >\n    </div>\n    <svg @click=", " style=\"border: 2px solid; width:100%; height:60ex\">\n      ", "\n    </svg>\n    ", "\n  "], ["\n    <div style=\"content-align:center\">\n      <span\n        class=\"pure-button pure-button-primary\"\n        ?disabled=", "\n        @click=", "\n        >Undo</span\n      >\n      <span\n        class=\"pure-button pure-button-primary\"\n        ?disabled=", "\n        @click=", "\n        >Redo</span\n      >\n    </div>\n    <svg @click=", " style=\"border: 2px solid; width:100%; height:60ex\">\n      ", "\n    </svg>\n    ", "\n  "])), !undo.length, Undo, !redo.length, Redo, newCircle, state.map(function (_a, index) {
      var x = _a.x,
          y = _a.y,
          r = _a.r;
      return lit_html_1.svg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n          <circle cx=", " cy=", " r=", " \n            style=\"fill:", ";stroke-width: 1;stroke: black;transition: fill 0.2s ease 0s;\"\n             @click=", ">\n          </circle>"], ["\n          <circle cx=", " cy=", " r=", " \n            style=\"fill:", ";stroke-width: 1;stroke: black;transition: fill 0.2s ease 0s;\"\n             @click=", ">\n          </circle>"])), x, y, r, index === selected ? 'grey' : 'transparent', selectHandler(index));
...
function newCells() {
  var selected = undefined;
  var sheet = spreadsheet_1.newSpreadsheet();
...
},{"../node_modules/lit-html/lit-html":"node_modules/lit-html/lit-html.js","./spreadsheet":"ts/spreadsheet.ts","../node_modules/lit-html/directives/style-map.js":"node_modules/lit-html/directives/style-map.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","ts/app.ts"], null)
