...
},{"./spreadsheet":"ts/spreadsheet.ts"}],"ts/bulma-view.ts":[function(require,module,exports) {
"use strict";
...
var labeledInput = function labeledInput(label, control) {
...
var newCounter = function newCounter(counter) {
  return function () {
    return labeledInput(counter.count, lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      <button class=\"button is-link\" @click=", ">Count</button>\n    "], ["\n      <button class=\"button is-link\" @click=", ">Count</button>\n    "])), counter.incr));
  };
};
...
function newConverter(converter) {
  ...
  var li = function li(label, value, oninput) {
    return labeledInput(label, lit_html_1.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        <input class=\"input\" .value=", " @input=", " />\n      "], ["\n        <input class=\"input\" .value=", " @input=", " />\n      "])), value, oninput));
  };

  return function () {
    return lit_html_1.html(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    ", "\n    ", "\n  "], ["\n    ", "\n    ", "\n  "])), li('Celsius', converter.celsius, setCelsius), li('Fahrenheit', converter.fahrenheit, setFahrenheit));
  };
}
...
function newCrud(model) {
  ...
  return function () {
    return lit_html_1.html(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    ", "\n    <div class=\"field\">\n      <div class=\"control\">\n        <div class=\"select\" style=\"height:auto;width:100%\">\n          <select\n            style=\"height:auto;width:100%\"\n            size=\"5\"\n            @change=", "\n          >\n            ", "\n          </select>\n        </div>\n      </div>\n    </div>\n    ", "\n    ", "\n    <div class=\"field is-grouped is-grouped-multiline\">\n      <div class=\"control\">\n        <button class=\"button is-link\" @click=", ">Create</button>\n      </div>\n      <div class=\"control\">\n        <button\n          class=\"button is-link\"\n          ?disabled=", "\n          @click=", "\n        >\n          Update\n        </button>\n      </div>\n      <div class=\"control\">\n        <button\n          class=\"button is-link\"\n          ?disabled=", "\n          @click=", "\n        >\n          Delete\n        </button>\n      </div>\n    </div>\n  "], ["\n    ", "\n    <div class=\"field\">\n      <div class=\"control\">\n        <div class=\"select\" style=\"height:auto;width:100%\">\n          <select\n            style=\"height:auto;width:100%\"\n            size=\"5\"\n            @change=", "\n          >\n            ", "\n          </select>\n        </div>\n      </div>\n    </div>\n    ", "\n    ", "\n    <div class=\"field is-grouped is-grouped-multiline\">\n      <div class=\"control\">\n        <button class=\"button is-link\" @click=", ">Create</button>\n      </div>\n      <div class=\"control\">\n        <button\n          class=\"button is-link\"\n          ?disabled=", "\n          @click=", "\n        >\n          Update\n        </button>\n      </div>\n      <div class=\"control\">\n        <button\n          class=\"button is-link\"\n          ?disabled=", "\n          @click=", "\n        >\n          Delete\n        </button>\n      </div>\n    </div>\n  "])), labeledInput('Filter prefix', lit_html_1.html(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n        <input\n          type=\"text\"\n          class=\"input\"\n          .value=", "\n          @input=", "\n        />\n      "], ["\n        <input\n          type=\"text\"\n          class=\"input\"\n          .value=", "\n          @input=", "\n        />\n      "])), model.prefix, prefixChange)), selectionChange, model.mapPrefixFiltered(function (name, i) {
      return lit_html_1.html(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n                  <option value=", ">", "</option>\n                "], ["\n                  <option value=", ">", "</option>\n                "])), i, name);
    }), labeledInput('Surname', lit_html_1.html(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n        <p class=\"control\">", "</div>\n      "], ["\n        <p class=\"control\">", "</div>\n      "])), lastInput)), labeledInput('Name', lit_html_1.html(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n        <p class=\"control\">", "</div>\n      "], ["\n        <p class=\"control\">", "</div>\n      "])), firstInput)), create, model.selected === undefined, update, model.selected === undefined, deleteSelected);
  };
}
...
function newCircles(model) {
  ...
  var radiusControl = function radiusControl(_a) {
    var x = _a.x,
        y = _a.y,
        r = _a.r;
    return lit_html_1.html(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    <div>Adjust radius of circle at (", ", ", ")</div>\n    <div class=\"field\">\n      <div class=\"control\">\n        <input type=\"range\" @input=", " .value=", " />\n      </div>\n    </div>\n  "], ["\n    <div>Adjust radius of circle at (", ", ", ")</div>\n    <div class=\"field\">\n      <div class=\"control\">\n        <input type=\"range\" @input=", " .value=", " />\n      </div>\n    </div>\n  "])), x, y, adjustRadius, r);
  };
...
function newCells(sheet) {
  ...
  return function () {
    return lit_html_1.html(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n    <style>\n      #sheet th {\n        min-width: 6ch;\n      }\n      #sheet td:first-child,\n      #sheet tr:first-child {\n        user-select: none;\n        text-align: center;\n      }\n    </style>\n    <div class=\"table-container\" style=\"height:66ex;overflow:auto\">\n      <table id=\"sheet\" class=\"table is-bordered\">\n        <tr>\n          <th style=\"min-width:1ch\"></th>\n          ", "\n        </tr>\n        ", "\n      </table>\n    </div>\n    <span>\n      Click inside a cell to edit its content. Hit enter to apply. Click outside\n      the cell or hit escape to abort. Here are some example contents: '5.5',\n      'Some text', '=A1', '=sum(B2:C4)', '=div(C1, 5)'.\n    </span>\n  "], ["\n    <style>\n      #sheet th {\n        min-width: 6ch;\n      }\n      #sheet td:first-child,\n      #sheet tr:first-child {\n        user-select: none;\n        text-align: center;\n      }\n    </style>\n    <div class=\"table-container\" style=\"height:66ex;overflow:auto\">\n      <table id=\"sheet\" class=\"table is-bordered\">\n        <tr>\n          <th style=\"min-width:1ch\"></th>\n          ", "\n        </tr>\n        ", "\n      </table>\n    </div>\n    <span>\n      Click inside a cell to edit its content. Hit enter to apply. Click outside\n      the cell or hit escape to abort. Here are some example contents: '5.5',\n      'Some text', '=A1', '=sum(B2:C4)', '=div(C1, 5)'.\n    </span>\n  "])), Array.from({
      ...
      return lit_html_1.html(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n            <tr>\n              <td><b>", "</b></td>\n              ", "\n            </tr>\n          "], ["\n            <tr>\n              <td><b>", "</b></td>\n              ", "\n            </tr>\n          "])), i, Array.from({
        length: 26
      }, function (_, j) {
        return selected && selected.i === i && selected.j === j ? editableCell : lit_html_1.html(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n                      <td\n                        @click=", "\n                      >\n                        ", "\n                      </td>\n                    "], ["\n                      <td\n                        @click=", "\n                      >\n                        ", "\n                      </td>\n                    "])), function (e) {
          selected = {
            i: i,
            j: j
          };
...
var renderBody = function renderBody() {
  return lit_html_1.render(lit_html_1.html(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n      <div class=\"tabs is-boxed\">\n        <ul>\n          <li>Examples</li>\n          ", "\n        </ul>\n      </div>\n      <p></p>\n      <div\n        style=\"margin-left:auto; margin-right:auto; max-width:48em; color:#777\"\n      >\n        ", "\n      </div>\n    "], ["\n      <div class=\"tabs is-boxed\">\n        <ul>\n          <li>Examples</li>\n          ", "\n        </ul>\n      </div>\n      <p></p>\n      <div\n        style=\"margin-left:auto; margin-right:auto; max-width:48em; color:#777\"\n      >\n        ", "\n      </div>\n    "])), Object.entries(examples).map(function (_a) {
    var k = _a[0],
        name = _a[1].name;
    return lit_html_1.html(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\n                <li\n                  class=", "\n                >\n                  <a href=\"#", "\">", "</a>\n                </li>\n              "], ["\n                <li\n                  class=", "\n                >\n                  <a href=\"#", "\">", "</a>\n                </li>\n              "])), '#' + k === window.location.hash ? 'is-active' : '', k, name);
  }), Object.entries(examples).map(function (_a) {
    var k = _a[0],
        render = _a[1].render;
    return lit_html_1.html(templateObject_20 || (templateObject_20 = __makeTemplateObject(["\n              <div\n                style=\"", "\"\n              >\n                ", "\n              </div>\n            "], ["\n              <div\n                style=\"", "\"\n              >\n                ", "\n              </div>\n            "])), style_map_js_1.styleMap('#' + k === window.location.hash ? {} : {
      display: 'none'
    }), render());
  })), document.body);
};
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","ts/bulma-view.ts"], null)
//# sourceMappingURL=/bulma-view.c631d19b.js.map